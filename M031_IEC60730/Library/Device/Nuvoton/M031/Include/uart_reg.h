...
typedef struct
{
     ...
     * |        |          |Note1: Refer to Figure 7.11-13 and Figure 7.11-14 for UART function mode.
     * |        |          |Note2: Refer to Figure 7.11-24 and Figure 7.11-25 for RS-485 function mode.
     ...
     * |        |          |The detail description is shown in Table 7.11-4.
     ...
     * |        |          |Note1: When the system is in Power-down mode, Received Data FIFO reached threshold will wake-up system from Power-down mode.
     * |        |          |Note2: This bit is valid in UART0 and UART1.
     ...
     * |        |          |Note3: This bit is valid in UART0 and UART1.
